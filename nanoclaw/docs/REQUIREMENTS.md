...
Shabti gives you the core functionality without that mess.
...
- Custom `shabti` MCP server (inside container) provides scheduling tools
...
**Shabti** - A reference to Clawdbot (now OpenClaw).
