...
import { BACKUP_DIR, BASE_DIR, BASE_INCLUDES, SHABTI_DIR } from './constants.js';
...
export function initShabtiDir(): void {
  const projectRoot = process.cwd();
  const shabtiDir = path.join(projectRoot, SHABTI_DIR);
