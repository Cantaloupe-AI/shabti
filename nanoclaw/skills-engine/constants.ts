export const SHABTI_DIR = '.shabti';
export const STATE_FILE = 'state.yaml';
export const BASE_DIR = '.shabti/base';
export const BACKUP_DIR = '.shabti/backup';
export const LOCK_FILE = '.shabti/lock';
export const CUSTOM_DIR = '.shabti/custom';
