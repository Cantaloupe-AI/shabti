...
<html><head><title>Shabti - WhatsApp Auth</title>
...
<html><head><title>Shabti - Connected!</title>
<style>
...
<script>localStorage.removeItem('shabti_qr_start');</script>
</body></html>`;
